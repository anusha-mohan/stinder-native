...
export default class App extends React.Component {
  ...
  getIdeas() {
    ...
    let airtableUrl = "https://api.airtable.com/v0/appIV5M2uxSXDNlPP/ideas?&view=Grid%20view";
  ...
  upvoteIdea(data, secId, rowId, rowMap) {
    ...
    let airtableUrl = "https://api.airtable.com/v0/appIV5M2uxSXDNlPP/ideas/" + data.id;
